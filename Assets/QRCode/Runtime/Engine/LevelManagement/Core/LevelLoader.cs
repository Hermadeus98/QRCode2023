namespace QRCode.Framework
{
    ...
    public class LevelLoader
    {
        ...
        {
            await LevelLoadingManagementService.ChangeLevel(gameLevelToLoad, m_loadingScreenEnum, m_forceReload);
        }
        
        public async Task LoadLevel()
        {
            await LevelLoadingManagementService.LoadLevel(gameLevelToLoad, m_loadingScreenEnum, m_forceReload);
        }

        public async Task UnloadLevel()
        {
            await LevelLoadingManagementService.UnloadLevel(gameLevelToLoad);
        }
    }
}
