namespace QRCode.Engine.Core.GameState
{
    ...
    public abstract class GameStateBase : StateMachineBehaviour
    {
        ...
        {
            QRDebug.Debug(Constants.EngineConstants.EngineLogChannels.GameStateStatusChannel, $"Enter in : {m_gameStateName}");
        ...
        {
            QRDebug.Debug(Constants.EngineConstants.EngineLogChannels.GameStateStatusChannel, $"Exit : {m_gameStateName}");
