namespace QRCode.Framework
{
    ...
    public class ProgressBar : UIElement
    {
        ...
        [TitleGroup(K.InspectorGroups.Settings)] [SerializeField] [PropertyRange("@this.m_minValue", "@this.m_maxValue")]
        ...
        [TitleGroup(K.InspectorGroups.Cosmetics)] [SerializeField]
        protected Gradient m_fillColorGradient = null;

        [TitleGroup(K.InspectorGroups.Debugging)] [ReadOnly] [SerializeField]
